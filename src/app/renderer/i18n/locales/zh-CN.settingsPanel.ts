export const zhCNSettingsPanel = {
  ...
  integrations: {
    ...
    openclawApi: {
      title: 'OpenClaw API',
      help: '连接 OpenClaw Gateway 以使用 AI Agent 功能。',
      enabledLabel: '启用 OpenClaw API',
      enabledHelp: '启用与 OpenClaw Agent API 的集成。',
      gatewayUrlLabel: 'Gateway 地址',
      gatewayUrlHelp: 'OpenClaw Gateway 服务器的基础 URL。',
      gatewayUrlPlaceholder: 'http://localhost:12082',
      testConnectionLabel: '测试连接',
      testConnectionHelp: '验证与 OpenClaw Gateway 的连接。',
      testConnection: '测试连接',
      testing: '测试中...',
      connectionSuccess: '连接成功',
      connectionFailed: '连接失败：{{error}}',
      oauthLabel: 'OAuth 授权',
      oauthHelp: '授权应用访问 OpenClaw Gateway。',
      authorize: '授权',
      authorizing: '授权中...',
    },
  },
