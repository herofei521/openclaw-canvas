export const enSettingsPanel = {
  ...
  integrations: {
    ...
    openclawApi: {
      title: 'OpenClaw API',
      help: 'Connect to an OpenClaw Gateway for AI agent integration.',
      enabledLabel: 'Enable OpenClaw API',
      enabledHelp: 'Enable integration with OpenClaw Agent API.',
      gatewayUrlLabel: 'Gateway URL',
      gatewayUrlHelp: 'The base URL of the OpenClaw Gateway server.',
      gatewayUrlPlaceholder: 'http://localhost:12082',
      testConnectionLabel: 'Test Connection',
      testConnectionHelp: 'Verify connectivity to the OpenClaw Gateway.',
      testConnection: 'Test Connection',
      testing: 'Testing...',
      connectionSuccess: 'Connected',
      connectionFailed: 'Failed: {{error}}',
      oauthLabel: 'OAuth Authorization',
      oauthHelp: 'Authorize the application to access OpenClaw Gateway.',
      authorize: 'Authorize',
